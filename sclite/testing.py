...
def build_guarded_strict_verification_result_fixture(
    ...
    *,
    ...
    """Build legacy v1 JSON for tests and compatibility fixtures only.

    This helper performs no verification. Its output is forgeable test data and
    must never be accepted as proof without re-verifying the source bundle or
    using a separately authenticated trusted channel.
    """
