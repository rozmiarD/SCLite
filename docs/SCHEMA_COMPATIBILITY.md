...
`sclite-core==1.0.8` is the current source package line; most current
...
| Watchdog decision | `watchdog_decision.v0.1` | current | `tests/test_watchdog_decisions.py` | Bounded RExecOp runtime-supervisor observation/admission truth projection; runtime supervision remains outside SCLite. |
