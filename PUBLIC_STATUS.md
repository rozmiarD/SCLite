...
- PyPI publication: not completed yet.
...
Before publication, run the validation and build gates in `PUBLICATION_CHECKLIST.md` and get explicit operator approval for any tag or upload.
