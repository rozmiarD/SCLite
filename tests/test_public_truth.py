...
def test_public_truth_validator_passes() -> None:
    ...
    assert result.stdout.strip() == 'public_truth_ok:sclite-core==1.0.3:import=sclite:runtime_deps=0'
...
def test_public_truth_validator_accepts_published_stable_install_claim() -> None:
    ...
    validator._assert_readme_package_truth(
        ...
        '\n'.join([
            'Version: `1.0.3`',
            'package-sclite--core%201.0.3-blueviolet.svg',
            'https://pypi.org/project/sclite-core/1.0.3/',
