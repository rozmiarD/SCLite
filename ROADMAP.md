...
## Current baseline: 1.0.3

Current package: `sclite-core==1.0.3`.
Latest published public package: `sclite-core==1.0.3`.

Roadmap v2 hardening from the 2026-06-14 audit is implemented in the
published `1.0.3` line. It keeps SCLite as a
...
```text
0.2.5 -> 0.3.0 -> 0.3.5 -> 0.4.0 -> 0.4.5 -> 0.5.0 -> 0.5.1 -> 0.6.0a0 -> 0.7.0a0 -> 0.8.0a0 -> 0.8.0b2 -> 1.0.0rc1 -> 1.0.0 -> 1.0.1 -> 1.0.2 -> 1.0.3
```
