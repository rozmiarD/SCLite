...
Status: **published 1.0.4 stable: frozen lifecycle/review and guarded verification surface**.
Current package is `sclite-core==1.0.4`, and the Python import package remains
